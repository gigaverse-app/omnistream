...
describe('Communities API Routes', () => {
  describe('POST /api/v1/communities', () => {
    ...
    it('should return 400 if name is missing', async () => {
      const response = await request(app).post('/api/v1/communities').send({});
    ...
    it('should return 400 if name is not a string', async () => {
      const response = await request(app).post('/api/v1/communities').send({ name: 123 });
    ...
    it('should return 400 if name is empty string', async () => {
      const response = await request(app).post('/api/v1/communities').send({ name: '' });
  ...
  describe('GET /api/v1/communities', () => {
    it('should return empty array when no communities exist', async () => {
      const response = await request(app).get('/api/v1/communities');
